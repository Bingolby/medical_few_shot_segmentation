...
class Deeplab(nn.Module):
    def __init__(self, args):
        ...
        backbone = resnet.__dict__[args.backbone_name]( pretrained=args.pretrained, replace_stride_with_dilation=replace_stride_with_dilation )
        self.backbone = IntermediateLayerGetter(backbone, return_layers=return_layers)
        inplanes = 2048
        low_level_planes = 256
        self.aspp = DeepLabHeadV3Plus(inplanes, low_level_planes, args.num_classes_tr, aspp_dilate)
